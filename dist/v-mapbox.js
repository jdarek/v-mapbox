(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('map-promisified')) :
  typeof define === 'function' && define.amd ? define(['exports', 'map-promisified'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VMapbox = {}, global.mapPromisified));
}(this, (function (exports, promisify) { 'use strict';
  ...
  var withAsyncActions = {
    ...
    methods: {
      $_registerAsyncActions: function $_registerAsyncActions(map) {
        this.actions = _objectSpread2(_objectSpread2({}, promisify__default['default'](map)), {}, {
          stop: function stop() {
            var _this = this;
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-23a8b106_0", { source: ".mgl-map-wrapper {\n  height: 100%;\n  position: relative;\n  width: 100%;\n}\n.mgl-map-wrapper .mapboxgl-map {\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n}\n\n/*# sourceMappingURL=GlMap.vue.map */", map: {"version":3,"sources":["D:\\projects\\Vestergaard\\dtsng-electron-app\\v-mapbox\\src\\components\\map\\GlMap.vue","GlMap.vue"],"names":[],"mappings":"AAoHA;EACA,YAAA;EACA,kBAAA;EACA,WAAA;ACnHA;ADsHA;EACA,YAAA;EACA,OAAA;EACA,kBAAA;EACA,MAAA;EACA,WAAA;ACnHA;;AAEA,oCAAoC","file":"GlMap.vue","sourcesContent":["<template>\r\n  <div class=\"mgl-map-wrapper\">\r\n    <div v-once :id=\"container\" ref=\"container\" />\r\n    <slot v-if=\"initialized\" />\r\n  </div>\r\n</template>\r\n\r\n<script>\r\n  import withEvents from '../../lib/withEvents';\r\n  import mapEvents from './events';\r\n  import options from './options';\r\n  import withWatchers from './mixins/withWatchers';\r\n  import withPrivateMethods from './mixins/withPrivateMethods';\r\n  import withAsyncActions from './mixins/withAsyncActions';\r\n\r\n  export default {\r\n    name: 'GlMap',\r\n\r\n    mixins: [withWatchers, withAsyncActions, withPrivateMethods, withEvents],\r\n\r\n    provide() {\r\n      const self = this;\r\n      return {\r\n        get mapbox() {\r\n          return self.mapbox;\r\n        },\r\n        get map() {\r\n          return self.map;\r\n        },\r\n        get actions() {\r\n          return self.actions;\r\n        },\r\n      };\r\n    },\r\n\r\n    props: {\r\n      mapboxGl: {\r\n        type: Object,\r\n        default: null,\r\n      },\r\n      ...options,\r\n    },\r\n\r\n    data() {\r\n      return {\r\n        initial: true,\r\n        initialized: false,\r\n      };\r\n    },\r\n\r\n    computed: {\r\n      loaded() {\r\n        return this.map ? this.map.loaded() : false;\r\n      },\r\n      version() {\r\n        return this.map ? this.map.version : null;\r\n      },\r\n      isStyleLoaded() {\r\n        return this.map ? this.map.isStyleLoaded() : false;\r\n      },\r\n      areTilesLoaded() {\r\n        return this.map ? this.map.areTilesLoaded() : false;\r\n      },\r\n      isMoving() {\r\n        return this.map ? this.map.isMoving() : false;\r\n      },\r\n      canvas() {\r\n        return this.map ? this.map.getCanvas() : null;\r\n      },\r\n      canvasContainer() {\r\n        return this.map ? this.map.getCanvasContainer() : null;\r\n      },\r\n      images() {\r\n        return this.map ? this.map.listImages() : null;\r\n      },\r\n    },\r\n\r\n    created() {\r\n      this.map = null;\r\n      this.propsIsUpdating = {};\r\n      this.mapboxPromise = this.mapboxGl\r\n        ? Promise.resolve(this.mapboxGl)\r\n        : import('mapbox-gl');\r\n    },\r\n\r\n    mounted() {\r\n      this.$_loadMap().then((map) => {\r\n        this.map = map;\r\n        if (\r\n          this.RTLTextPluginUrl !== undefined &&\r\n          this.mapbox.getRTLTextPluginStatus() !== 'loaded'\r\n        ) {\r\n          this.mapbox.setRTLTextPlugin(\r\n            this.RTLTextPluginUrl,\r\n            this.$_RTLTextPluginError,\r\n          );\r\n        }\r\n        const eventNames = Object.keys(mapEvents);\r\n        this.$_bindMapEvents(eventNames);\r\n        this.$_registerAsyncActions(map);\r\n        this.$_bindPropsUpdateEvents();\r\n        this.initial = false;\r\n        this.initialized = true;\r\n        this.$emit('load', { map, component: this });\r\n      });\r\n    },\r\n\r\n    beforeDestroy() {\r\n      this.$nextTick(() => {\r\n        if (this.map) this.map.remove();\r\n      });\r\n    },\r\n  };\r\n</script>\r\n\r\n<style lang=\"scss\">\r\n  .mgl-map-wrapper {\r\n    height: 100%;\r\n    position: relative;\r\n    width: 100%;\r\n  }\r\n\r\n  .mgl-map-wrapper .mapboxgl-map {\r\n    height: 100%;\r\n    left: 0;\r\n    position: absolute;\r\n    top: 0;\r\n    width: 100%;\r\n  }\r\n</style>\r\n",".mgl-map-wrapper {\n  height: 100%;\n  position: relative;\n  width: 100%;\n}\n\n.mgl-map-wrapper .mapboxgl-map {\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n}\n\n/*# sourceMappingURL=GlMap.vue.map */"]}, media: undefined });
  ...
  var layerMixin = {
    ...
    watch: {
      before: function before(layer, oldLayer) {
        if (layer !== oldLayer) {
          this.move(layer);
        }
      }
  ...
  var MglMap = __vue_component__$2;
  ...
  var MglPopup = __vue_component__;
